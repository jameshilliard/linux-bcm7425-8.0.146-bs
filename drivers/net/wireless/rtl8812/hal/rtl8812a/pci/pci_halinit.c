	...
	)
{
	...
	Hal_ReadAntennaDiversity8821A(Adapter, pHalData->efuse_eeprom_data, pHalData->bautoload_fail_flag);
...
)
{
	...
	if (_InitPowerOn_8812AE(Adapter) == _FAIL)
		DBG_871X("InitPowerOn Fail!!\n");
...
_func_enter_;
	...
	{
		VOID PowerOffAdapter8812E(PADAPTER);
