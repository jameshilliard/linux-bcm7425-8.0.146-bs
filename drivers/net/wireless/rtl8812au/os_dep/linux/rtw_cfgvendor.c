...
// nothing seems to use this, and it's not immediately clear where we
// should get the wdev parameter required by
// rtw_cfg80211_vendor_event_alloc from, so let's just disable it for
// now.
#if 0
/*
