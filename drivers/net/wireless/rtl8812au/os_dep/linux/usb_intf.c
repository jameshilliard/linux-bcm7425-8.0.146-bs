...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	/****** 8188CTV ********/
	{USB_DEVICE(0x0, 0x094c),.driver_info = RTL8188C_8192C}, /* I-O DATA - Edimax */
	/****** 8188CTV ********/
	...
	{USB_DEVICE(0x2357, 0x0101),.driver_info = RTL8812}, /* TP-Link - Cameo */
        {USB_DEVICE(0x2357, 0x0103),.driver_info = RTL8812}, /* TP-Link - Cameo */
        {USB_DEVICE(0x2357, 0x010D),.driver_info = RTL8812}, /* TP-Link - T4Uv2 - no TPLink driver, added by BrightSign */
#endif
