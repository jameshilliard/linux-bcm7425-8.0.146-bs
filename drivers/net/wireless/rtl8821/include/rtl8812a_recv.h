...
#define SET_RX_STATUS_DESC_BUFF_ADDR_8812(__pRxDesc, __Value)	do { SET_BITS_TO_LE_4BYTE(__pRxDesc+24, 0, 32, ((u32)(__Value & 0xffffffff))); SET_BITS_TO_LE_4BYTE(__pRxDesc+28, 0, 32, ((u32)(__Value >> 32))); } while (0)
