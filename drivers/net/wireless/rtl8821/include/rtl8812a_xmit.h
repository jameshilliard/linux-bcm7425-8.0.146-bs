...
/* Dword 10 */
#define SET_TX_DESC_TX_BUFFER_ADDRESS_8812(__pTxDesc, __Value)	do { SET_BITS_TO_LE_4BYTE(__pTxDesc+40, 0, 32, ((u32)(__Value & 0xffffffff))); SET_BITS_TO_LE_4BYTE(__pTxDesc+44, 0, 32, ((u32)(__Value >> 32))); } while (0)
#define GET_TX_DESC_TX_BUFFER_ADDRESS_8812(__pTxDesc)	LE_BITS_TO_4BYTE(__pTxDesc+40, 0, 32)

/* Dword 11 */
#define SET_TX_DESC_NEXT_DESC_ADDRESS_8812(__pTxDesc, __Value)	do { SET_BITS_TO_LE_4BYTE(__pTxDesc+48, 0, 32, ((u32)(__Value & 0xffffffff))); SET_BITS_TO_LE_4BYTE(__pTxDesc+52, 0, 32, ((u32)(__Value >> 32))); } while (0)
