...
void __init cma_reserve(void)
{
	...
	/* Use the Brightsign configuration from device-tree unless it has been
	 * overridden via boot parameters.
	 */
	if (!brcmstb_memory_override_defaults && !n_cma_regions)
		brightsign_memory_cma_reserve(__cma_rsv_setup);
#endif
