...
#if defined(CONFIG_SERIAL_8250_POLARITY_INVERSION)
static int
serial8250_ioctl(struct uart_port *uport, unsigned int cmd,
		 unsigned long arg)
{
	struct uart_8250_port *up = container_of(uport, struct uart_8250_port, port);
...
#endif /* CONFIG_SERIAL_8250_POLARITY_INVERSION */
static const char *
